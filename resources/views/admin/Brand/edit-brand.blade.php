        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <h3 class="text-center text-success">{{ Session::get('message')}}</h3>
                        {!! Form::open(['route' => 'update-brand','mathod' => 'post']) !!}
                            <div class="form-group">
                                    <label for="" class="control-label col-md-4">Brand Name</label>
                                    <div class="col-md-8">
                                        <input type="text" name="brand_name" value="{{ $brand->brand_name }}" id="" class="form-control"/>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-md-8 radio">
                                       <label for=""><input type="radio" checked name="publication_status" {{ $brand->publication_status == 1 ? 'checked' : ''}} value="1">published</label>
                                       <label for=""><input type="radio"  name="publication_status" {{ $brand->publication_status == 0 ? 'checked' : ''}}  value="0">unpubished</label>
                                    </div>
                            </div>
                            <div class="form-group">
